...
import { openAddModal, closeAddModal, openMemberProfile, closeMemberModal, openAddMemberModal, openEditMemberModal, openPastoralGreetingModal, closePastoralGreetingModal, sendPastoralGreetingVia, openKeyboardCheatsheetModal, closeKeyboardCheatsheetModal, openHHFolderModal, closeHHFolderModal, openCSTFolderModal, closeCSTFolderModal, closeMemberProfileModal, openBatchIDPrintModal, openUploadResourceModal, closeUploadResourceModal, saveCustomResourceFile, renderCustomUploadedResources, openLetterGeneratorModal, closeLetterGeneratorModal, updateLetterPreview, downloadLetterPDF, openMemberIDCard, closeMemberIDCardModal, openPostAnnouncementModal, closePostAnnouncementModal, handlePostAnnouncement, openSubmitPrayerModal, closeSubmitPrayerModal, handleSubmitPrayer, closeAllActiveModals, toggleAIPastoralChat, handleAIChatSubmit, pinVenueLocation, closeVenueMapModal, handleVenueMapModalPin, handleCustomVenuePinSubmit, updateFormMapPreview, previewFormLocationOnMap } from './modules/ui-modals.js';
import { triggerConfettiBurst, transposeNote, openSongbookTransposerModal, closeSongbookTransposerModal, loadSongForTransposer, transposeSongKey, resetSongKey, renderTransposedSong, openInteractiveRosaryModal, closeInteractiveRosaryModal, selectRosaryMystery, nextRosaryBead, prevRosaryBead, renderRosaryState, renderGamificationLeaderboard, toggleAudioPlay, downloadCertificatePDF } from './modules/tools.js';


import { toggleAgendaSort, setAgendaSemester, setAgendaViewMode, refreshAgendaHistory, downloadActivityPDF, selectActivityForAttendance, handleFormSubmit, clearAllActivities } from './modules/activities.js';
import { setOrgViewMode, getMemberAttendanceRate, matchOrgDepartment, getCanonicalChapterName, renderOrgMemberCard, renderOrgChart, getRoleRank, formatRoleBadge, calculateAgeClean, checkAddMemberDuplicate, filterDuplicateMembers, renderMembersTable, renderMembersMobileCards, formatDateClean, clearAllMembers, generateMemberIDMatrixSVG, exportMemberDossierPDF, calculateAgeFromBirthday, closeAddMemberModal, handleAddMemberSubmit } from './modules/members.js';
import { exportFinancialStatementPDF, exportFinancialLedgerCSV, renderFundsTable, openReceiptViewerModal, closeReceiptViewerModal, filterFunds, resetFundsFilter, updateFundCategories, triggerReceiptUpload, handleReceiptImageSelect, removeReceiptImage, updateReceiptPreviewUI, openAddFundModal, closeAddFundModal, saveFundRecord, deleteFundRecord } from './modules/funds.js';
import { setupSpotlights, animateCounter, initApp, updateSyncStatus, updateBadgeCount } from './modules/core.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.openPastoralGreetingModal = window.openPastoralGreetingModal || openPastoralGreetingModal;
    window.closePastoralGreetingModal = window.closePastoralGreetingModal || closePastoralGreetingModal;
    window.sendPastoralGreetingVia = window.sendPastoralGreetingVia || sendPastoralGreetingVia;
    window.openKeyboardCheatsheetModal = window.openKeyboardCheatsheetModal || openKeyboardCheatsheetModal;
    window.closeKeyboardCheatsheetModal = window.closeKeyboardCheatsheetModal || closeKeyboardCheatsheetModal;
    ...
    window.renderCustomUploadedResources = window.renderCustomUploadedResources || renderCustomUploadedResources;
    window.openLetterGeneratorModal = window.openLetterGeneratorModal || openLetterGeneratorModal;
    window.closeLetterGeneratorModal = window.closeLetterGeneratorModal || closeLetterGeneratorModal;
    ...
    window.openPostAnnouncementModal = window.openPostAnnouncementModal || openPostAnnouncementModal;
    window.closePostAnnouncementModal = window.closePostAnnouncementModal || closePostAnnouncementModal;
    ...
    window.handleCustomVenuePinSubmit = window.handleCustomVenuePinSubmit || handleCustomVenuePinSubmit;
    ...
    window.openSongbookTransposerModal = window.openSongbookTransposerModal || openSongbookTransposerModal;
    window.closeSongbookTransposerModal = window.closeSongbookTransposerModal || closeSongbookTransposerModal;
    ...
    window.openInteractiveRosaryModal = window.openInteractiveRosaryModal || openInteractiveRosaryModal;
    window.closeInteractiveRosaryModal = window.closeInteractiveRosaryModal || closeInteractiveRosaryModal;
    ...
    window.renderGamificationLeaderboard = window.renderGamificationLeaderboard || renderGamificationLeaderboard;
    ...
    window.selectActivityForAttendance = window.selectActivityForAttendance || selectActivityForAttendance;
    ...
    window.exportFinancialStatementPDF = window.exportFinancialStatementPDF || exportFinancialStatementPDF;
    ...
    window.closeCreateAccountModal = window.closeCreateAccountModal || Legacy.closeCreateAccountModal;
    window.toggleAccountChapterGroup = window.toggleAccountChapterGroup || Legacy.toggleAccountChapterGroup;
    ...
    window.exportToGoogleSheetsTSV = window.exportToGoogleSheetsTSV || Legacy.exportToGoogleSheetsTSV;
    ...
    window.startInactivityWatchdog = window.startInactivityWatchdog || Legacy.startInactivityWatchdog;
    ...
    window.restoreFromAutoRecoverySnapshot = window.restoreFromAutoRecoverySnapshot || Legacy.restoreFromAutoRecoverySnapshot;
    window.resetSystemToDefault = window.resetSystemToDefault || Legacy.resetSystemToDefault;
    window.autoSendBatchPastoralGmail = window.autoSendBatchPastoralGmail || Legacy.autoSendBatchPastoralGmail;
    window.copyPastoralMessage = window.copyPastoralMessage || Legacy.copyPastoralMessage;
    window.updateTopSearchHighlight = window.updateTopSearchHighlight || Legacy.updateTopSearchHighlight;
    window.updateCmdPaletteHighlight = window.updateCmdPaletteHighlight || Legacy.updateCmdPaletteHighlight;
    ...
    window.handleCommandPaletteSearch = window.handleCommandPaletteSearch || Legacy.handleCommandPaletteSearch;
    ...
    window.handleAddResourceSubmit = window.handleAddResourceSubmit || Legacy.handleAddResourceSubmit;
    ...
    window.applyHiddenStaticResources = window.applyHiddenStaticResources || Legacy.applyHiddenStaticResources;
    window.hideStaticResource = window.hideStaticResource || Legacy.hideStaticResource;
    window.openRemoveResourceModal = window.openRemoveResourceModal || Legacy.openRemoveResourceModal;
    window.closeRemoveResourceModal = window.closeRemoveResourceModal || Legacy.closeRemoveResourceModal;
    ...
    window.openFirebaseConfigModal = window.openFirebaseConfigModal || Legacy.openFirebaseConfigModal;
    window.closeFirebaseConfigModal = window.closeFirebaseConfigModal || Legacy.closeFirebaseConfigModal;
    window.saveFirebaseConfigSettings = window.saveFirebaseConfigSettings || Legacy.saveFirebaseConfigSettings;
    window.triggerFirebaseForceSync = window.triggerFirebaseForceSync || Legacy.triggerFirebaseForceSync;
    window.triggerFirebasePull = window.triggerFirebasePull || Legacy.triggerFirebasePull;
    window.generateExecutiveSummaryPDF = window.generateExecutiveSummaryPDF || Legacy.generateExecutiveSummaryPDF;
    ...
    window.exportExecutiveSummaryPDF = window.exportExecutiveSummaryPDF || Legacy.exportExecutiveSummaryPDF;
    ...
    window.printOfficialCertificate = window.printOfficialCertificate || Legacy.printOfficialCertificate;
    window.renderCalendarAndPrayerWall = window.renderCalendarAndPrayerWall || Legacy.renderCalendarAndPrayerWall;
    window.openAttendanceMatrixModal = window.openAttendanceMatrixModal || Legacy.openAttendanceMatrixModal;
    window.closeAttendanceMatrixModal = window.closeAttendanceMatrixModal || Legacy.closeAttendanceMatrixModal;
    window.renderAttendanceMatrixSheet = window.renderAttendanceMatrixSheet || Legacy.renderAttendanceMatrixSheet;
    window.exportAttendanceMatrixCSV = window.exportAttendanceMatrixCSV || Legacy.exportAttendanceMatrixCSV;
    window.closeBirthdayCardModal = window.closeBirthdayCardModal || Legacy.closeBirthdayCardModal;
    window.copyBirthdayCardMessage = window.copyBirthdayCardMessage || Legacy.copyBirthdayCardMessage;
    window.printMemberReportCardFromModal = window.printMemberReportCardFromModal || Legacy.printMemberReportCardFromModal;
    window.renderAttendanceHeatmapWidget = window.renderAttendanceHeatmapWidget || Legacy.renderAttendanceHeatmapWidget;
    window.openHouseholdTreeViewModal = window.openHouseholdTreeViewModal || Legacy.openHouseholdTreeViewModal;
    window.closeHouseholdTreeViewModal = window.closeHouseholdTreeViewModal || Legacy.closeHouseholdTreeViewModal;
    window.triggerMemberAutoAwardFromModal = window.triggerMemberAutoAwardFromModal || Legacy.triggerMemberAutoAwardFromModal;
    ...
    window.openAbsenteeSwiperModal = window.openAbsenteeSwiperModal || Legacy.openAbsenteeSwiperModal;
    window.closeAbsenteeSwiperModal = window.closeAbsenteeSwiperModal || Legacy.closeAbsenteeSwiperModal;
    ...
    window.moveAttendanceKeyboardHighlight = window.moveAttendanceKeyboardHighlight || Legacy.moveAttendanceKeyboardHighlight;
    window.triggerKeyboardAttendanceAction = window.triggerKeyboardAttendanceAction || Legacy.triggerKeyboardAttendanceAction;
    window.printBlankAttendanceSheet = window.printBlankAttendanceSheet || Legacy.printBlankAttendanceSheet;
    ...
    window.generateOfficialLedgerPDF = window.generateOfficialLedgerPDF || Legacy.generateOfficialLedgerPDF;
    ...
    window.renderAnnouncementsBoard = window.renderAnnouncementsBoard || Legacy.renderAnnouncementsBoard;
