                        ...
                        <div class="glass-panel">
                            ...
                            <div class="attendance-toolbar">
                                <div class="attendance-select-box">
                                    <label for="attendance-activity-select">Select Activity:</label>
                                    <select
                                        id="attendance-activity-select"
                                        class="custom-select lg-select"
                                    >
                                        <option value="">
                                ...
                                <div id="attendance-status-pill" class="status-pill-grey">
                                    ● Select an activity above
                                </div>

                                <div
                                    class="attendance-quick-actions"
                                ...
                                >
                                    ...
                                    <button class="btn-secondary btn-sm" id="btn-mark-all-present">
                                        <svg
                                            viewBox="0 0 24 24"
                                            fill="none"
                                            stroke="currentColor"
                                    ...
                                    <button
                                        class="btn-secondary btn-sm text-red"
                            ...
                            <div
                                class="attendance-batch-toolbar"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        oninput="filterAttendanceRoster()"
                                        style="
                                ...
                                >
                                    <span
                                        style="font-size: 0.78rem; font-weight: 700; color: #94a3b8"
                                        >Batch Check-In:</span
                                    >
                                    <button
                                        id="action-btn-31"
                                        class="ext-style-65 btn-secondary btn-sm"
                            ...
                            <div
                                class="attendance-progress-banner"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                >Present:
                                                <strong id="count-present" style="color: #34d399"
                                                    >0</strong
                                                ></span
                                            >
                                        </div>
                                        ...
                                        >
                                            ...
                                            <span
                                                >Absent:
                                                <strong id="count-absent" style="color: #fb7185"
                                                    >0</strong
                                                ></span
                                            >
                                        </div>
                                        <div
                                            class="progress-item"
                                            style="font-size: 0.84rem; color: #94a3b8"
                                        >
                                            <span
                                                >Total Recorded:
                                                <strong
                                                    id="count-total-checkins"
                                                    style="color: #fff"
                                                    >0</strong
                                                ></span
                                            >
                                ...
                                <div class="multi-progress-bar mt-2">
                                    <div
                            ...
                            <!-- Empty State Notice -->
                            <div class="empty-state" id="attendance-empty-state">
                            ...
                            <div
                                ...
                                style="display: none"
                            >
                                <table class="data-table attendance-roster-table">
                                    <thead>
                                        <tr>
