...
<div id="view-funds" class="view-panel">
                        ...
                        <div class="metrics-grid">
                            ...
                            <div
                                ...
                                style="border-top-width: 3px; border-top-color: #10b981"
                            >
                                ...
                                <div class="metric-footer">
                                    <span class="badge badge-green">Inflow</span>
                                    <span class="metric-subtext">Total chapter receipts</span>
                                </div>
                            </div>
                            ...
                            <div
                                class="metric-card glass-card"
                                style="border-top-width: 3px; border-top-color: #ef4444"
                            >
                                <div class="metric-header">
                                ...
                                <div class="metric-footer">
                                    <span
                                        ...
                                        >Outflow</span
                                    >
                                    <span class="metric-subtext">Total disbursements</span>
                                </div>
                            </div>
                            ...
                            <div
                                class="metric-card glass-card"
                                style="border-top-width: 3px; border-top-color: #8b5cf6"
                            >
                                <div class="metric-header">
                                ...
                                <div class="metric-footer">
                                    <span class="badge badge-blue">Net Funds</span>
                                    <span class="metric-subtext">Available cash balance</span>
                                </div>
                            </div>
                            ...
                            <div
                                class="metric-card glass-card"
                                style="border-top-width: 3px; border-top-color: #38bdf8"
                            >
                                <div class="metric-header">
                                ...
                                <div class="metric-value" id="stat-total-records">0</div>
                                <div class="metric-footer">
                                    <span class="badge badge-green">Ledger</span>
                                    <span class="metric-subtext">Logged transactions</span>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                                    ...
                                    <div class="ext-style-35">
                                        ...
                                        <div>
                                            ...
                                            <span class="ext-style-70"
                                                >Chapter monthly cashflow balance</span
                                            >
                                        </div>
                                    </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span class="badge badge-purple">Distribution</span>
                                </div>
                                <div style="position: relative; height: 210px; width: 100%">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="search-box"
                                    style="width: 260px; height: 42px; border-radius: 12px"
                                >
                                    <svg
                                        class="search-icon"
                                        viewBox="0 0 24 24"
