...
<div id="view-analytics" class="view-panel">
                        ...
                        <div class="export-banner glass-card">
                            ...
                            <div class="export-actions">
                                <button class="btn-export btn-csv" id="btn-export-csv">
                                    <svg
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <button class="btn-export btn-pdf" id="btn-export-pdf">
                                    <svg
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <label
                                    for="input-restore-file"
                                    class="btn-export btn-restore"
                                    id="btn-restore-json"
                                    style="
                                        cursor: pointer;
                                        margin: 0;
                        ...
                        >
                            <div class="glass-panel" style="padding: 24px">
                                <div class="ext-style-60 panel-header">
                                    <div class="panel-title-box">
                                        <h3 style="font-size: 1.1rem; color: #f8fafc">
                        ...
                        <div
                            class="glass-panel mt-6"
                            style="padding: 24px; border-left: 4px solid var(--accent-rose)"
                        >
                            <div
                                style="
                                    display: flex;
                            ...
                            >
                                ...
                                <button
                                    id="action-btn-51"
                                    class="btn-secondary"
                                    style="border-color: rgba(244, 63, 94, 0.4); color: #f43f5e"
                                >
