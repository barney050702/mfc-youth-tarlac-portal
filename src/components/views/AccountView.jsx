...
export default function AccountView() {
    return (
        <div id="view-account" className="view-panel">
            <div
                style={{
                    display: 'flex',
            ...
            >
                ...
                <div style={{ color: '#94a3b8', fontSize: '0.88rem', fontWeight: 500 }}>
                    Manage Super Admins and Chapter Heads
                </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                >
                    ...
                    <input
                        ...
                        accept=".json"
                        onChange={(e) => window.restoreBackupJSON && window.restoreBackupJSON(e)}
                        style={{ display: 'none' }}
                    />
                </label>
                ...
                >
                    ...
                    <span>Restore Auto-Snapshot</span>
                </button>
