...
import { refreshAgendaHistory, setAgendaSemester, toggleAgendaSort } from './activities.js';
import {
...
export function initializeEventListeners() {
    ...
    if (el_action_btn_1) {
        el_action_btn_1.addEventListener('click', function (_event) {
            closeWhatsNewModal();
        });
    }
    ...
    if (el_action_btn_2) {
        el_action_btn_2.addEventListener('click', function (_event) {
            closeWhatsNewModal();
        });
    }
    ...
    if (el_sidebar_backdrop) {
        el_sidebar_backdrop.addEventListener('click', function (_event) {
            closeMobileSidebar();
        });
    }
    ...
    if (el_action_btn_3) {
        el_action_btn_3.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_4) {
        el_action_btn_4.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_5) {
        el_action_btn_5.addEventListener('click', function (_event) {
            switchView('members');
        });
    }
    ...
    if (el_action_btn_6) {
        el_action_btn_6.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_7) {
        el_action_btn_7.addEventListener('click', function (_event) {
            switchView('funds');
        });
    }
    ...
    if (el_action_btn_8) {
        el_action_btn_8.addEventListener('click', function (_event) {
            switchView('agenda');
        });
    }
    ...
    if (el_action_btn_9) {
        el_action_btn_9.addEventListener('click', function (_event) {
            switchView('servants');
        });
    }
    ...
    if (el_action_btn_10) {
        el_action_btn_10.addEventListener('click', function (_event) {
            switchView('orgchart');
        });
    }
    ...
    if (el_action_btn_11) {
        el_action_btn_11.addEventListener('click', function (_event) {
    ...
    if (el_menu_toggle_btn) {
        el_menu_toggle_btn.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_13) {
        el_action_btn_13.addEventListener('click', function (_event) {
            openCommandPalette();
        });
    }
    ...
    if (el_firebase_cloud_status_btn) {
        el_firebase_cloud_status_btn.addEventListener('click', function (_event) {
            openFirebaseConfigModal();
        });
    }
    ...
    if (el_install_pwa_btn) {
        el_install_pwa_btn.addEventListener('click', function (_event) {
            triggerPWAInstall();
        });
    }
    ...
    if (el_cheatsheet_btn) {
        el_cheatsheet_btn.addEventListener('click', function (_event) {
            openKeyboardCheatsheetModal();
        });
    }
    ...
    if (el_portal_sync_badge) {
        el_portal_sync_badge.addEventListener('click', function (_event) {
            exportFullBackupJSON();
        });
    }
    ...
    if (el_profile_toggle_btn) {
        el_profile_toggle_btn.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_14) {
        el_action_btn_14.addEventListener('click', function (_event) {
            logoutUser();
        });
    }
    ...
    if (el_action_btn_15) {
        el_action_btn_15.addEventListener('click', function (_event) {
            exportExecutiveSummaryPDF();
        });
    }
    ...
    if (el_action_btn_16) {
        el_action_btn_16.addEventListener('click', function (_event) {
            exportFullBackupJSON();
        });
    }
    ...
    if (el_tab_s1) {
        el_tab_s1.addEventListener('click', function (_event) {
    ...
    if (el_tab_s2) {
        el_tab_s2.addEventListener('click', function (_event) {
    ...
    if (el_tab_all) {
        el_tab_all.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_19) {
        el_action_btn_19.addEventListener('click', function (_event) {
    ...
    if (el_agenda_sort_btn) {
        el_agenda_sort_btn.addEventListener('click', function (_event) {
            toggleAgendaSort();
        });
    }
    ...
    if (el_action_btn_20) {
        el_action_btn_20.addEventListener('click', function (_event) {
            refreshAgendaHistory();
        });
    }
    ...
    if (el_action_btn_21) {
        el_action_btn_21.addEventListener('click', function (_event) {
            openAddModal();
        });
    }
    ...
    if (el_action_btn_22) {
        el_action_btn_22.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_23) {
        el_action_btn_23.addEventListener('click', function (_event) {
            navigateCalendarMonth(1);
        });
    }
    ...
    if (el_btn_open_qr_scanner) {
        el_btn_open_qr_scanner.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_24) {
        el_action_btn_24.addEventListener('click', function (_event) {
            markAllAbsent();
        });
    }
    ...
    if (el_action_btn_25) {
        el_action_btn_25.addEventListener('click', function (_event) {
            sendGmailToCurrentAbsentees();
        });
    }
    ...
    if (el_action_btn_26) {
        el_action_btn_26.addEventListener('click', function (_event) {
            exportToPDF();
        });
    }
    ...
    if (el_action_btn_27) {
        el_action_btn_27.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_28) {
        el_action_btn_28.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_29) {
        el_action_btn_29.addEventListener('click', function (_event) {
            openAttendanceMatrixModal();
        });
    }
    ...
    if (el_action_btn_30) {
        el_action_btn_30.addEventListener('click', function (_event) {
            printBlankAttendanceSheet();
        });
    }
    ...
    if (el_action_btn_31) {
        el_action_btn_31.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_32) {
        el_action_btn_32.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_33) {
        el_action_btn_33.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_34) {
        el_action_btn_34.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_35) {
        el_action_btn_35.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_36) {
        el_action_btn_36.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_37) {
        el_action_btn_37.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_38) {
        el_action_btn_38.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_39) {
        el_action_btn_39.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_40) {
        el_action_btn_40.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_41) {
        el_action_btn_41.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_42) {
        el_action_btn_42.addEventListener('click', function (_event) {
            exportMembersToPDF();
        });
    }
    ...
    if (el_action_btn_43) {
        el_action_btn_43.addEventListener('click', function (_event) {
            exportMembersCSV();
        });
    }
    ...
    if (el_action_btn_44) {
        el_action_btn_44.addEventListener('click', function (_event) {
            openMemberIDCard();
        });
    }
    ...
    if (el_action_btn_45) {
        el_action_btn_45.addEventListener('click', function (_event) {
            if (window.startLiveQRScanner) window.startLiveQRScanner();
        });
    }
    ...
    if (el_action_btn_46) {
        el_action_btn_46.addEventListener('click', function (_event) {
            openCertificateModal();
        });
    }
    ...
    if (el_action_btn_47) {
        el_action_btn_47.addEventListener('click', function (_event) {
            openHouseholdTreeViewModal();
        });
    }
    ...
    if (el_action_btn_48) {
        el_action_btn_48.addEventListener('click', function (_event) {
            printBlankAttendanceSheet();
        });
    }
    ...
    if (el_action_btn_49) {
        el_action_btn_49.addEventListener('click', function (_event) {
            clearAllMembers();
        });
    }
    ...
    if (el_btn_filter_duplicates) {
        el_btn_filter_duplicates.addEventListener('click', function (_event) {
            filterDuplicateMembers();
        });
    }
    ...
    if (el_action_btn_50) {
        el_action_btn_50.addEventListener('click', function (_event) {
            exportToGoogleSheetsTSV();
        });
    }
    ...
    if (el_btn_backup_json) {
        el_btn_backup_json.addEventListener('click', function (_event) {
            exportBackupJSON();
        });
    }
    ...
    if (el_action_btn_51) {
        el_action_btn_51.addEventListener('click', function (_event) {
            generatePastoralList();
        });
    }
    ...
    if (el_btn_org_tree) {
        el_btn_org_tree.addEventListener('click', function (_event) {
            setOrgViewMode('tree');
        });
    }
    ...
    if (el_btn_org_grid) {
        el_btn_org_grid.addEventListener('click', function (_event) {
            setOrgViewMode('grid');
        });
    }
    ...
    if (el_btn_org_household) {
        el_btn_org_household.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_52) {
        el_action_btn_52.addEventListener('click', function (_event) {
            openBatchIDPrintModal();
        });
    }
    ...
    if (el_action_btn_53) {
        el_action_btn_53.addEventListener('click', function (_event) {
            openAddMemberModal();
        });
    }
    ...
    if (el_action_btn_54) {
        el_action_btn_54.addEventListener('click', function (_event) {
            resetFundsFilter();
        });
    }
    ...
    if (el_action_btn_55) {
        el_action_btn_55.addEventListener('click', function (_event) {
            exportFinancialLedgerCSV();
        });
    }
    ...
    if (el_action_btn_56) {
        el_action_btn_56.addEventListener('click', function (_event) {
            generateOfficialLedgerPDF();
        });
    }
    ...
    if (el_action_btn_57) {
        el_action_btn_57.addEventListener('click', function (_event) {
            openAddFundModal();
        });
    }
    ...
    if (el_action_btn_58) {
        el_action_btn_58.addEventListener('click', function (_event) {
            openDownloadAllModal();
        });
    }
    ...
    if (el_btn_res_youthcamp) {
        el_btn_res_youthcamp.addEventListener('click', function (_event) {
    ...
    if (el_btn_res_trainings) {
        el_btn_res_trainings.addEventListener('click', function (_event) {
    ...
    if (el_btn_res_songboard) {
        el_btn_res_songboard.addEventListener('click', function (_event) {
    ...
    if (el_btn_res_holyrosary) {
        el_btn_res_holyrosary.addEventListener('click', function (_event) {
    ...
    if (el_btn_res_letters) {
        el_btn_res_letters.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_59) {
        el_action_btn_59.addEventListener('click', function (_event) {
            openHHFolderModal();
        });
    }
    ...
    if (el_action_btn_60) {
        el_action_btn_60.addEventListener('click', function (_event) {
            openCSTFolderModal();
        });
    }
    ...
    if (el_action_btn_61) {
        el_action_btn_61.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_62) {
        el_action_btn_62.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_63) {
        el_action_btn_63.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_64) {
        el_action_btn_64.addEventListener('click', function (_event) {
            openSongbookTransposerModal();
        });
    }
    ...
    if (el_action_btn_65) {
        el_action_btn_65.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_66) {
        el_action_btn_66.addEventListener('click', function (_event) {
            openInteractiveRosaryModal();
        });
    }
    ...
    if (el_action_btn_67) {
        el_action_btn_67.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_68) {
        el_action_btn_68.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_69) {
        el_action_btn_69.addEventListener('click', function (_event) {
            openLetterGeneratorModal('parental');
        });
    }
    ...
    if (el_action_btn_70) {
        el_action_btn_70.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_71) {
        el_action_btn_71.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_72) {
        el_action_btn_72.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_73) {
        el_action_btn_73.addEventListener('click', function (_event) {
            closeDownloadAllModal();
        });
    }
    ...
    if (el_action_btn_74) {
        el_action_btn_74.addEventListener('click', function (_event) {
            closeDownloadAllModal();
        });
    }
    ...
    if (el_btn_start_batch_download) {
        el_btn_start_batch_download.addEventListener('click', function (_event) {
            startBatchDownload();
        });
    }
    ...
    if (el_action_btn_75) {
        el_action_btn_75.addEventListener('click', function (_event) {
            closeHHFolderModal();
        });
    }
    ...
    if (el_action_btn_76) {
        el_action_btn_76.addEventListener('click', function (_event) {
            closeHHFolderModal();
        });
    }
    ...
    if (el_action_btn_77) {
        el_action_btn_77.addEventListener('click', function (_event) {
            closeCSTFolderModal();
        });
    }
    ...
    if (el_action_btn_78) {
        el_action_btn_78.addEventListener('click', function (_event) {
            closeCSTFolderModal();
        });
    }
    ...
    if (el_action_btn_79) {
        el_action_btn_79.addEventListener('click', function (_event) {
            openCreateAccountModal();
        });
    }
    ...
    if (el_action_btn_80) {
        el_action_btn_80.addEventListener('click', function (_event) {
            exportBackupJSON();
        });
    }
    ...
    if (el_action_btn_81) {
        el_action_btn_81.addEventListener('click', function (_event) {
            restoreFromAutoRecoverySnapshot();
        });
    }
    ...
    if (el_action_btn_82) {
        el_action_btn_82.addEventListener('click', function (_event) {
            resetSystemToDefault();
        });
    }
    ...
    if (el_action_btn_83) {
        el_action_btn_83.addEventListener('click', function (_event) {
            closeAddModal();
        });
    }
    ...
    if (el_action_btn_84) {
        el_action_btn_84.addEventListener('click', function (_event) {
            previewFormLocationOnMap();
        });
    }
    ...
    if (el_action_btn_85) {
        el_action_btn_85.addEventListener('click', function (_event) {
            closeAddModal();
        });
    }
    ...
    if (el_action_btn_86) {
        el_action_btn_86.addEventListener('click', function (_event) {
            closeCreateAccountModal();
        });
    }
    ...
    if (el_action_btn_87) {
        el_action_btn_87.addEventListener('click', function (_event) {
            closeMemberModal();
        });
    }
    ...
    if (el_action_btn_88) {
        el_action_btn_88.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_89) {
        el_action_btn_89.addEventListener('click', function (_event) {
            printMemberReportCardFromModal();
        });
    }
    ...
    if (el_action_btn_90) {
        el_action_btn_90.addEventListener('click', function (_event) {
            triggerMemberAutoAwardFromModal();
        });
    }
    ...
    if (el_action_btn_91) {
        el_action_btn_91.addEventListener('click', function (_event) {
            closeMemberModal();
        });
    }
    ...
    if (el_action_btn_92) {
        el_action_btn_92.addEventListener('click', function (_event) {
            closeImportCSVModal();
        });
    }
    ...
    if (el_action_btn_93) {
        el_action_btn_93.addEventListener('click', function (_event) {
            autoArrangeCSVContent();
        });
    }
    ...
    if (el_action_btn_94) {
        el_action_btn_94.addEventListener('click', function (_event) {
            closeImportCSVModal();
        });
    }
    ...
    if (el_action_btn_95) {
        el_action_btn_95.addEventListener('click', function (_event) {
            autoArrangeCSVContent();
        });
    }
    ...
    if (el_action_btn_96) {
        el_action_btn_96.addEventListener('click', function (_event) {
            processCSVImport();
        });
    }
    ...
    if (el_action_btn_97) {
        el_action_btn_97.addEventListener('click', function (_event) {
            closeHouseholdTreeViewModal();
        });
    }
    ...
    if (el_action_btn_98) {
        el_action_btn_98.addEventListener('click', function (_event) {
            closeHouseholdTreeViewModal();
        });
    }
    ...
    if (el_action_btn_99) {
        el_action_btn_99.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_100) {
        el_action_btn_100.addEventListener('click', function (_event) {
            printMemberIDCard();
        });
    }
    ...
    if (el_action_btn_101) {
        el_action_btn_101.addEventListener('click', function (_event) {
            if (window.closeDigitalQRModal) window.closeDigitalQRModal();
        });
    }
    ...
    if (el_action_btn_102) {
        el_action_btn_102.addEventListener('click', function (_event) {
            closeAddMemberModal();
        });
    }
    ...
    if (el_action_btn_103) {
        el_action_btn_103.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_104) {
        el_action_btn_104.addEventListener('click', function (_event) {
            closeAddMemberModal();
        });
    }
    ...
    if (el_action_btn_105) {
        el_action_btn_105.addEventListener('click', function (_event) {
            closeAddFundModal();
        });
    }
    ...
    if (el_receipt_upload_box) {
        el_receipt_upload_box.addEventListener('click', function (_event) {
            triggerReceiptUpload();
        });
    }
    ...
    if (el_action_btn_106) {
        el_action_btn_106.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_107) {
        el_action_btn_107.addEventListener('click', function (_event) {
            closeAddFundModal();
        });
    }
    ...
    if (el_user_profile_backdrop) {
        el_user_profile_backdrop.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_108) {
        el_action_btn_108.addEventListener('click', function (_event) {
            closeUserProfileModal();
        });
    }
    ...
    if (el_action_btn_109) {
        el_action_btn_109.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_110) {
        el_action_btn_110.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_111) {
        el_action_btn_111.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_112) {
        el_action_btn_112.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_113) {
        el_action_btn_113.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_114) {
        el_action_btn_114.addEventListener('click', function (_event) {
            switchProfileModalView('menu');
        });
    }
    ...
    if (el_action_btn_115) {
        el_action_btn_115.addEventListener('click', function (_event) {
            saveNewPasscode();
        });
    }
    ...
    if (el_action_btn_116) {
        el_action_btn_116.addEventListener('click', function (_event) {
            switchProfileModalView('menu');
        });
    }
    ...
    if (el_action_btn_117) {
        el_action_btn_117.addEventListener('click', function (_event) {
            switchProfileModalView('menu');
        });
    }
    ...
    if (el_action_btn_118) {
        el_action_btn_118.addEventListener('click', function (_event) {
            saveRecoveryOptions();
        });
    }
    ...
    if (el_action_btn_119) {
        el_action_btn_119.addEventListener('click', function (_event) {
            switchProfileModalView('menu');
        });
    }
    ...
    if (el_action_btn_120) {
        el_action_btn_120.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_121) {
        el_action_btn_121.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_122) {
        el_action_btn_122.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_123) {
        el_action_btn_123.addEventListener('click', function (_event) {
            switchProfileModalView('menu');
        });
    }
    ...
    if (el_action_btn_124) {
        el_action_btn_124.addEventListener('click', function (_event) {
            if (state.auditLog) {
                state.auditLog = [];
                localStorage.removeItem('ps_audit_log');
                renderAuditLog();
    ...
    if (el_action_btn_125) {
        el_action_btn_125.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_126) {
        el_action_btn_126.addEventListener('click', function (_event) {
            if (window.startLiveQRScanner) window.startLiveQRScanner();
        });
    }
    ...
    if (el_action_btn_127) {
        el_action_btn_127.addEventListener('click', function (_event) {
            simulateQRCheckIn();
        });
    }
    ...
    if (el_action_btn_128) {
        el_action_btn_128.addEventListener('click', function (_event) {
            if (window.stopLiveQRScanner) window.stopLiveQRScanner();
        });
    }
    ...
    if (el_action_btn_129) {
        el_action_btn_129.addEventListener('click', function (_event) {
            window.dispatchEvent(
                new CustomEvent('close-react-modal', {
                    detail: { modalName: 'modal-receipt-viewer' },
                })
            );
        });
    }
    ...
    if (el_action_btn_130) {
        el_action_btn_130.addEventListener('click', function (_event) {
            window.dispatchEvent(
                new CustomEvent('close-react-modal', {
                    detail: { modalName: 'modal-receipt-viewer' },
                })
    ...
    if (el_action_btn_131) {
        el_action_btn_131.addEventListener('click', function (_event) {
            if (window.closeDigitalQRModal) window.closeDigitalQRModal();
        });
    }
    ...
    if (el_action_btn_132) {
        el_action_btn_132.addEventListener('click', function (_event) {
            printMemberQRCard();
        });
    }
    ...
    if (el_action_btn_133) {
        el_action_btn_133.addEventListener('click', function (_event) {
            if (window.closeDigitalQRModal) window.closeDigitalQRModal();
        });
    }
    ...
    if (el_action_btn_134) {
        el_action_btn_134.addEventListener('click', function (_event) {
            closeMemberProfileModal();
        });
    }
    ...
    if (el_action_btn_135) {
        el_action_btn_135.addEventListener('click', function (_event) {
            closePublishModal();
        });
    }
    ...
    if (el_action_btn_136) {
        el_action_btn_136.addEventListener('click', function (_event) {
            closePublishModal();
        });
    }
    ...
    if (el_action_btn_137) {
        el_action_btn_137.addEventListener('click', function (_event) {
            closeFirebaseConfigModal();
        });
    }
    ...
    if (el_action_btn_138) {
        el_action_btn_138.addEventListener('click', function (_event) {
            triggerFirebaseForceSync();
        });
    }
    ...
    if (el_action_btn_139) {
        el_action_btn_139.addEventListener('click', function (_event) {
            triggerFirebasePull();
        });
    }
    ...
    if (el_action_btn_140) {
        el_action_btn_140.addEventListener('click', function (_event) {
            closeFirebaseConfigModal();
        });
    }
    ...
    if (el_action_btn_141) {
        el_action_btn_141.addEventListener('click', function (_event) {
            saveFirebaseConfigSettings();
        });
    }
    ...
    if (el_action_btn_142) {
        el_action_btn_142.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_143) {
        el_action_btn_143.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_144) {
        el_action_btn_144.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_145) {
        el_action_btn_145.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_146) {
        el_action_btn_146.addEventListener('click', function (_event) {
            // closePastoralFollowUpModal();
        });
    }
    ...
    if (el_action_btn_147) {
        el_action_btn_147.addEventListener('click', function (_event) {
            closeCertificateModal();
        });
    }
    ...
    if (el_action_btn_148) {
        el_action_btn_148.addEventListener('click', function (_event) {
            closeCertificateModal();
        });
    }
    ...
    if (el_action_btn_149) {
        el_action_btn_149.addEventListener('click', function (_event) {
            printOfficialCertificate();
        });
    }
    ...
    if (el_action_btn_150) {
        el_action_btn_150.addEventListener('click', function (_event) {
            closeAttendanceMatrixModal();
        });
    }
    ...
    if (el_action_btn_151) {
        el_action_btn_151.addEventListener('click', function (_event) {
            closeAttendanceMatrixModal();
        });
    }
    ...
    if (el_action_btn_152) {
        el_action_btn_152.addEventListener('click', function (_event) {
            exportAttendanceMatrixCSV();
        });
    }
    ...
    if (el_action_btn_153) {
        el_action_btn_153.addEventListener('click', function (_event) {
            window.print();
        });
    }
    ...
    if (el_action_btn_154) {
        el_action_btn_154.addEventListener('click', function (_event) {
            closeBirthdayCardModal();
        });
    }
    ...
    if (el_action_btn_155) {
        el_action_btn_155.addEventListener('click', function (_event) {
            closeBirthdayCardModal();
        });
    }
    ...
    if (el_action_btn_156) {
        el_action_btn_156.addEventListener('click', function (_event) {
            copyBirthdayCardMessage();
        });
    }
    ...
    if (el_action_btn_157) {
        el_action_btn_157.addEventListener('click', function (_event) {
            closeAbsenteeSwiperModal();
        });
    }
    ...
    if (el_swiper_prev_btn) {
        el_swiper_prev_btn.addEventListener('click', function (_event) {
            prevAbsenteeSlide();
        });
    }
    ...
    if (el_action_btn_158) {
        el_action_btn_158.addEventListener('click', function (_event) {
            closeAbsenteeSwiperModal();
        });
    }
    ...
    if (el_swiper_next_btn) {
        el_swiper_next_btn.addEventListener('click', function (_event) {
            nextAbsenteeSlide();
        });
    }
    ...
    if (el_action_btn_159) {
        el_action_btn_159.addEventListener('click', function (_event) {
            closeCommandPalette();
        });
    }
    ...
    if (el_action_btn_160) {
        el_action_btn_160.addEventListener('click', function (_event) {
            closeKeyboardCheatsheetModal();
        });
    }
    ...
    if (el_action_btn_161) {
        el_action_btn_161.addEventListener('click', function (_event) {
            closeKeyboardCheatsheetModal();
            openCommandPalette();
        });
    }
    ...
    if (el_action_btn_162) {
        el_action_btn_162.addEventListener('click', function (_event) {
            closeKeyboardCheatsheetModal();
            if (window.startLiveQRScanner) window.startLiveQRScanner();
        });
    }
    ...
    if (el_action_btn_163) {
        el_action_btn_163.addEventListener('click', function (_event) {
            closeKeyboardCheatsheetModal();
            openAddMemberModal();
        });
    }
    ...
    if (el_action_btn_164) {
        el_action_btn_164.addEventListener('click', function (_event) {
            closeKeyboardCheatsheetModal();
        });
    }
    ...
    if (el_btn_send_whatsapp_greeting) {
        el_btn_send_whatsapp_greeting.addEventListener('click', function (_event) {
    ...
    if (el_btn_send_gmail_greeting) {
        el_btn_send_gmail_greeting.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_165) {
        el_action_btn_165.addEventListener('click', function (_event) {
            closePastoralGreetingModal();
        });
    }
    ...
    if (el_action_btn_166) {
        el_action_btn_166.addEventListener('click', function (_event) {
            switchView('dashboard');
        });
    }
    ...
    if (el_action_btn_167) {
        el_action_btn_167.addEventListener('click', function (_event) {
            switchView('attendance');
        });
    }
    ...
    if (el_action_btn_168) {
        el_action_btn_168.addEventListener('click', function (_event) {
            switchView('members');
        });
    }
    ...
    if (el_action_btn_169) {
        el_action_btn_169.addEventListener('click', function (_event) {
            switchView('funds');
        });
    }
    ...
    if (el_action_btn_170) {
        el_action_btn_170.addEventListener('click', function (_event) {
            toggleMobileSidebar();
        });
    }
    ...
    if (el_action_btn_171) {
        el_action_btn_171.addEventListener('click', function (_event) {
            openAddMemberModal();
        });
    }
    ...
    if (el_action_btn_172) {
        el_action_btn_172.addEventListener('click', function (_event) {
            switchView('dashboard');
        });
    }
    ...
    if (el_action_btn_173) {
        el_action_btn_173.addEventListener('click', function (_event) {
            switchView('members');
        });
    }
    ...
    if (el_action_btn_174) {
        el_action_btn_174.addEventListener('click', function (_event) {
            switchView('activities');
        });
    }
    ...
    if (el_action_btn_175) {
        el_action_btn_175.addEventListener('click', function (_event) {
            switchView('funds');
        });
    }
    ...
    if (el_action_btn_176) {
        el_action_btn_176.addEventListener('click', function (_event) {
            closeUploadResourceModal();
        });
    }
    ...
    if (el_action_btn_177) {
        el_action_btn_177.addEventListener('click', function (_event) {
            closeUploadResourceModal();
        });
    }
    ...
    if (el_action_btn_178) {
        el_action_btn_178.addEventListener('click', function (_event) {
            closeLetterGeneratorModal();
        });
    }
    ...
    if (el_action_btn_179) {
        el_action_btn_179.addEventListener('click', function (_event) {
            closeLetterGeneratorModal();
        });
    }
    ...
    if (el_action_btn_180) {
        el_action_btn_180.addEventListener('click', function (_event) {
            downloadLetterPDF();
        });
    }
    ...
    if (el_action_btn_181) {
        el_action_btn_181.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_182) {
        el_action_btn_182.addEventListener('click', function (_event) {
            closeSongbookTransposerModal();
        });
    }
    ...
    if (el_action_btn_183) {
        el_action_btn_183.addEventListener('click', function (_event) {
            transposeSongKey(-1);
        });
    }
    ...
    if (el_action_btn_184) {
        el_action_btn_184.addEventListener('click', function (_event) {
            transposeSongKey(1);
        });
    }
    ...
    if (el_action_btn_185) {
        el_action_btn_185.addEventListener('click', function (_event) {
            resetSongKey();
        });
    }
    ...
    if (el_action_btn_186) {
        el_action_btn_186.addEventListener('click', function (_event) {
            closeSongbookTransposerModal();
        });
    }
    ...
    if (el_action_btn_187) {
        el_action_btn_187.addEventListener('click', function (_event) {
            closeInteractiveRosaryModal();
        });
    }
    ...
    if (el_ros_tab_joyful) {
        el_ros_tab_joyful.addEventListener('click', function (_event) {
    ...
    if (el_ros_tab_luminous) {
        el_ros_tab_luminous.addEventListener('click', function (_event) {
    ...
    if (el_ros_tab_sorrowful) {
        el_ros_tab_sorrowful.addEventListener('click', function (_event) {
    ...
    if (el_ros_tab_glorious) {
        el_ros_tab_glorious.addEventListener('click', function (_event) {
    ...
    if (el_action_btn_188) {
        el_action_btn_188.addEventListener('click', function (_event) {
            prevRosaryBead();
        });
    }
    ...
    if (el_action_btn_189) {
        el_action_btn_189.addEventListener('click', function (_event) {
            nextRosaryBead();
        });
    }
    ...
    if (el_action_btn_190) {
        el_action_btn_190.addEventListener('click', function (_event) {
            closeMemberIDCardModal();
        });
    }
    ...
    if (el_action_btn_191) {
        el_action_btn_191.addEventListener('click', function (_event) {
            closeMemberIDCardModal();
        });
    }
    ...
    if (el_action_btn_192) {
        el_action_btn_192.addEventListener('click', function (_event) {
            printMemberIDCard();
        });
    }
    ...
    if (el_action_btn_193) {
        el_action_btn_193.addEventListener('click', function (_event) {
            if (window.stopLiveQRScanner) window.stopLiveQRScanner();
        });
    }
    ...
    if (el_action_btn_194) {
        el_action_btn_194.addEventListener('click', function (_event) {
            if (window.stopLiveQRScanner) window.stopLiveQRScanner();
        });
    }
    ...
    if (el_action_btn_195) {
        el_action_btn_195.addEventListener('click', function (_event) {
            closePostAnnouncementModal();
        });
    }
    ...
    if (el_action_btn_196) {
        el_action_btn_196.addEventListener('click', function (_event) {
            closePostAnnouncementModal();
        });
    }
    ...
    if (el_action_btn_197) {
        el_action_btn_197.addEventListener('click', function (_event) {
            closeSubmitPrayerModal();
        });
    }
    ...
    if (el_action_btn_198) {
        el_action_btn_198.addEventListener('click', function (_event) {
            closeSubmitPrayerModal();
        });
    }
    ...
    if (el_ai_chat_trigger_btn) {
        el_ai_chat_trigger_btn.addEventListener('click', function (_event) {
            toggleAIPastoralChat();
        });
    }
    ...
    if (el_action_btn_199) {
        el_action_btn_199.addEventListener('click', function (_event) {
            toggleAIPastoralChat();
        });
    }
    ...
    if (el_audio_play_btn) {
        el_audio_play_btn.addEventListener('click', function (_event) {
            toggleAudioPlay();
        });
    }
    ...
    if (el_action_btn_200) {
        el_action_btn_200.addEventListener('click', function (_event) {
            closeCertificateModal();
        });
    }
    ...
    if (el_action_btn_201) {
        el_action_btn_201.addEventListener('click', function (_event) {
            closeCertificateModal();
        });
    }
    ...
    if (el_action_btn_202) {
        el_action_btn_202.addEventListener('click', function (_event) {
            downloadCertificatePDF();
        });
    }
    ...
    if (el_action_btn_203) {
        el_action_btn_203.addEventListener('click', function (_event) {
            closeVenueMapModal();
        });
    }
    ...
    if (el_action_btn_204) {
        el_action_btn_204.addEventListener('click', function (_event) {
            closeVenueMapModal();
        });
    }
}
